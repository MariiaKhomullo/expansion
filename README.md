...
## Использованные методы и метрикик
```
- Когортный анализ
- Юнит-экономика в разрезе когорт: CR, Frequency, AOV, ARPU, ARPPU, GPM, CPO, CPL, Profit per User
- Прогноз LTV
...
```
- Сводные таблицы, в том числе рассчитываемое поле. 
- ВПР и MINIFS
